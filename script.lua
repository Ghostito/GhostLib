...
NotificationFrame.Size = UDim2.new(0.979, 0,0.005, 0)
...
pos0.BackgroundTransparency = 1.000
pos0.Position = UDim2.new(1.24637949, 0, 0.206994578, 0)
pos0.Size = UDim2.new(0, 0, 0, 28)
